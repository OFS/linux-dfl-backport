...
#define M10BMC_PMCI_SDM_CMD_CTRL	0x234
#define M10BMC_PMCI_SDM_CMD_TRIG	BIT(0)
#define M10BMC_PMCI_SDM_REQ_CLR		BIT(1)
#define M10BMC_PMCI_SDM_CMD_SEL		GENMASK(11, 4)
#define PMCI_SDM_CMD_GET_PROV		3
#define M10BMC_PMCI_SDM_CMD_STATE	GENMASK(15, 12)
#define PMCI_SDM_CMD_STATE_IDLE		0
#define M10BMC_PMCI_SDM_CMD_ERR		GENMASK(23, 16)
#define PMCI_SDM_CMD_SUCCESS		0
