...
static int dfl_uart_probe(struct dfl_device *dfl_dev)
{
	...
	if (dfluart->line < 0) {
		...
		return dev_err(dev,
#else
		return dev_err_probe(dev, dfluart->line, 
#endif
